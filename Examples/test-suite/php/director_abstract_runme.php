...
// No new functions
check::functions(array(foo_ping,foo_pong,example0_getxsize,example0_color,example0_get_color,example1_getxsize,example1_color,example1_get_color,example2_getxsize,example2_color,example2_get_color,example4_getxsize,example4_color,example4_get_color,example3_i_color,example3_i_get_color,g));
// No new classes
...
$me1 = new MyExample1();
check::equal(Example1_get_color($me1, 1, 2, 3), 1, "Example1_get_color failed");

$me2 = new MyExample2(1, 2);
check::equal(Example2_get_color($me1, 1, 2, 3), 2, "Example2_get_color failed");

$me3 = new MyExample3();
check::equal(Example3_get_color($me3, 1, 2, 3), 3, "Example3_get_color failed");
